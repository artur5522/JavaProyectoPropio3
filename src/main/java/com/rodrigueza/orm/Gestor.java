...
public class Gestor {
  ...
  /*
    public Session creaSession() {
        return sesion = sesionFactory.openSession();
    }
*/
    ...
    public Object buscarPorId(Class clase, Long id) {
        ...
        /* // si no quiero que devuelva un object hago esto
        Query<Componente> consulta2 = sesion.createQuery("from " + clase.getSimpleName() + " a where a.id =" + id.toString());
        Componente compo = consulta2.getSingleResult();
            */
        return miObjeto3;
    }
